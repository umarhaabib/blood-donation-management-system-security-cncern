...
<div class=".col-lg-12">
               <h1 class="page-header">Blood Collection</h1>
				...
				<div class="row">
						...
						$qry="select * from blood ORDER BY id DESC";
						...
						while($row=mysqli_fetch_array($result)){
						  ...
						  <td><a href='editbloodform.php?id=".$row['id']."'><i class='icofont icofont-edit'></i></a> | <a href='deletebloodrecord.php?id=".$row['id']."'><i class='icofont icofont-ui-delete'></i></a></td>
