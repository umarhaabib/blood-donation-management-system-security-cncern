...
<head>
	...
	<script type="text/javascript">  
           ...
           {  
                ...
                var options = {  
                      title: 'Total Available Blood Groups',  
...
<?php include 'includes/nav.php'?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class=".col-lg-12">
                    <h1 class="page-header">Administator Dashboard</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
					  ...
					  <div class="container-fluid">
						...
						<div class="row-fluid">
						  ...
						  <div class="span12">
							...
							<div id="piechart" style="width: 90%; height: 320px; margin-left:auto; margin-right:auto;"></div>  
