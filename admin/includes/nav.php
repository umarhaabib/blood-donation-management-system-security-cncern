<!-- Navigation -->
<nav style="background: linear-gradient(90deg,#f60000,#4f414d);" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a style="color: aliceblue;" class="navbar-brand" href="index.php"><i class="icofont-blood-drop"></i>Blood Donation Management System </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div style="background: linear-gradient(90deg,#f60000,#4f414d);color:white;"  class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-user"></i> Donors <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
